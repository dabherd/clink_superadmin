 ...
 * @subpackage Configuration
 */
class PayPalDigitalGoodsConfiguration {
	 ...
	 * @static
	 * @param string $key The name of the property to set
	 * @return mixed return value of the property or null if the property does not exist
	 */
	...
	public static function local_code( $value = null ) {
